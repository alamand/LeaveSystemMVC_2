...
namespace LeaveSystemMVC.Controllers
{
    public class lmSubordinateLeaveHistoryController : ControllerBase
    {
        ...
        private string GetFilteredQuery(int leaveType, int leaveStat, string search, string order, string sDate, string eDate)
        {
            ...
            string queryString = "SELECT Leave_Application_ID, Employee.Employee_ID, First_Name, Last_Name, Leave.Start_Date, Leave.Reporting_Back_Date, Leave.Leave_Type_ID, Leave_Name, Leave_Type.Display_Name as Leave_Type_Display, " +
